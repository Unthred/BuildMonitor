...
public static class StatusPanelPresentationBuilder
{
        ...
        bool expandHistoryByDefault)
    {
        ...
        return new StatusPanelCardPresentation(
            ...
            ShowRebuildButton: StatusPanelCardActionRules.ShowRebuild(snapshot),
            ShowRestartButtons: StatusPanelCardActionRules.ShowRestart(snapshot),
            ShowRunTestsButton: StatusPanelCardActionRules.ShowRunTests(snapshot),
